                                ...
                                <div class="st-content">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="sc-pic">
                                                    <img src="{{ url('') }}/assets/img/schedule/schedule-1.jpg"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="col-lg-5">
                                ...
                                <div class="st-content">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="sc-pic">
                                                    <img src="{{ url('') }}/assets/img/schedule/schedule-2.jpg"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="col-lg-5">
                                ...
                                <div class="st-content">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="sc-pic">
                                                    <img src="{{ url('') }}/assets/img/schedule/schedule-3.jpg"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="col-lg-5">
                                ...
                                <div class="st-content">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="sc-pic">
                                                    <img src="{{ url('') }}/assets/img/schedule/schedule-4.jpg"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="col-lg-5">
